    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.CharField(choices=[('2019', '2019'), ('2020', '2020'), ('2021', '2021'), ('2022', '2022'), (
                    'Graduate Student', 'Graduate Student'), ('Faculty', 'Faculty'), ('Other', 'Other')], max_length=16)),
                ...
                ('endorsements', jsonfield.fields.JSONField(
                    blank=True, verbose_name=models.CharField(max_length=10))),
